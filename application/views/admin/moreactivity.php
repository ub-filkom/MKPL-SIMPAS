...
&nbsp;
														...
														<div class="profile-feed">
															...
															<div class="profile-activity clearfix">
																<div>
                                                                                                                                        ...
                                                                                                                                        <a class="user" href="#"> <?php echo $d->username; ?></a>
                                                                                                                                        
																	<?php echo $d->action;?>   
                                                                                                                                        (<?php echo $d->status;?>)
																	<div class="time">
																		<i class="ace-icon fa fa-clock-o bigger-110"></i>
																		<?php echo $d->time?> / <?php echo $d->tanggal?>
																	</div>
																</div>

																<div class="tools action-buttons">														
																	<a href="<?php echo base_url()."index.php/admin/delete/log/".$d->id;?>" class="red">
											...
											<div class="center">
												<button type="button" class="btn btn-sm btn-primary btn-white btn-round">
                                                                                                    <a href="<?php echo base_url();?>index.php/admin/activity/moreactivity">
